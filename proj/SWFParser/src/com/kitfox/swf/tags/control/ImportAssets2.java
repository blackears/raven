 ...
 * @author kitfox
 */
public class ImportAssets2 extends SWFTag
{
    public static class Reader extends SWFTagLoader
    {
        ...
        public SWFTag read(SWFDataReader in, int length) throws IOException
        {
            ...
            return new ImportAssets2(url, tags, names);
        }
    }

    public static final int TAG_ID = 71;

    String url;
    int[] tags;
    String[] names;

    public ImportAssets2(String url, int[] tags, String[] names)
    {
        this.url = url;
        this.tags = tags;
        this.names = names;
