 ...
 * @author kitfox
 */
public class SetTabIndex extends SWFTag
{
    public static class Reader extends SWFTagLoader
    {
        ...
        {
            int depth = in.getUI16();
            int tabIndex = in.getUI16();
            return new SetTabIndex(depth, tabIndex);
        }
    }

    public static final int TAG_ID = 66;
