 ...
 * @author kitfox
 */
public class ImportAssets extends SWFTag
{
    public static class Reader extends SWFTagLoader
    {
        ...
        public SWFTag read(SWFDataReader in, int length) throws IOException
        {
            ...
            return new ImportAssets(url, tags, names);
        }
    }

    public static final int TAG_ID = 57;

    String url;
    int[] tags;
    String[] names;

    public ImportAssets(String url, int[] tags, String[] names)
    {
        this.url = url;
        this.tags = tags;
        this.names = names;
