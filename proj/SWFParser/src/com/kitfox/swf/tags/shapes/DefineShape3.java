 ...
 * @author kitfox
 */
public class DefineShape3 extends SWFTag
{
    ...
    public DefineShape3(int shapeId, RECT shapeBounds, ShapeWithStyle shapes)
    {
    ...
    public static class Reader extends SWFTagLoader
    {
        ...
        public SWFTag read(SWFDataReader in, int length) throws IOException
        {
            ...
            ShapeWithStyle shapes = new ShapeWithStyle(in, 3);
            return new DefineShape3(shapeId, shapeBounds, shapes);
        }
    }
}
