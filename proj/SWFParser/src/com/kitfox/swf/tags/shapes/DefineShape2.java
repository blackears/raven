 ...
 * @author kitfox
 */
public class DefineShape2 extends SWFTag
{

    public static final int TAG_ID = 22;

    private int shapeId;
    private RECT shapeBounds;
    private ShapeWithStyle shapes;

    public DefineShape2(int shapeId, RECT shapeBounds, ShapeWithStyle shapes)
    {
    ...
    public static class Reader extends SWFTagLoader
    {
        ...
        public SWFTag read(SWFDataReader in, int length) throws IOException
        {
            ...
            ShapeWithStyle shapes = new ShapeWithStyle(in, 2);
            return new DefineShape2(shapeId, shapeBounds, shapes);
        }
    }
}
