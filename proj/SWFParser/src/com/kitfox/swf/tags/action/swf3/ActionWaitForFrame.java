...
package com.kitfox.swf.tags.action.swf3;
...
public class ActionWaitForFrame extends ActionRecord
{
    public static class Loader extends ActionRecordLoader
    {
        ...
        {
            int frame = in.getUI16();
            int skipCount = in.getUI8();
            return new ActionWaitForFrame(frame, skipCount);
        }
    }

    public static final int CODE = 0x8A;

    int frame;
    int skipCount;

    public ActionWaitForFrame(int frame, int skipCount) {
        this.frame = frame;
