...
public class ActionGetURL extends ActionRecord
{
    public static class Loader extends ActionRecordLoader
    {
        ...
        {
            String url = in.getString();
            String target = in.getString();
            return new ActionGetURL(url, target);
        }
    }

    public static final int CODE = 0x83;

    String url;
    String target;

    public ActionGetURL(String url, String target)
    {
        this.url = url;
        this.target = target;
    }
