 ...
 * @author kitfox
 */
public class PathDragSetKnot extends PathDragSet
{
    ArrayList<NetworkHandleKnot> pickKnot;

    public PathDragSetKnot(ServiceBezierPath servPath,
...
//            NetworkHandleEdge e1 = newHandles.getEdgeHandle(e0.getIndex());
            ...
            BezierPathEdge2i e = newPath.getEdge(e0.getIndex());
            if (update.k0 != null)
            {
                e.setK0x(update.k0.x);
                e.setK0y(update.k0.y);
            }
            if (update.k1 != null)
            {
                e.setK1x(update.k1.x);
                e.setK1y(update.k1.y);
            }
        }
