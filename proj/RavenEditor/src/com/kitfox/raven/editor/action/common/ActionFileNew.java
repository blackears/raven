 ...
 * @author kitfox
 */
public class ActionFileNew extends AbstractAction
{
    private static final String name = "New...";
    private static final String id = "fileNew";
    ...
    {
        RavenEditor.inst().getDocumentIOHelper().newFile();
    }
    ...
    public static class Provider extends ActionProvider
    {
        public Provider()
        {
            super(id, name, stroke, new ActionFileNew());
        }
    }
}
