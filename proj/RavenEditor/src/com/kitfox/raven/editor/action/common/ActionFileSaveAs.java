 ...
 * @author kitfox
 */
public class ActionFileSaveAs extends AbstractAction
{
    private static final String name = "Save As...";
    private static final String id = "fileSaveAs";
    ...
    {
        RavenEditor.inst().getDocumentIOHelper().saveAsFile();
    }
    ...
    public static class Provider extends ActionProvider
    {
        public Provider()
        {
            super(id, name, stroke, new ActionFileSaveAs());
        }
    }
}
