 ...
 * @author kitfox
 */
public class ActionPathVertexToCusp extends ActionPathVertexSmoothingChange
{
    private static final String name = "Vertex To Cusp";
    private static final String id = "pathVertexToCusp";
    private static final KeyStroke stroke = null;

    public ActionPathVertexToCusp()
    {
        super(name, VertexSmooth.CUSP);
    }
    ...
    public static class Provider extends ActionProvider
    {
        public Provider()
        {
            super(id, name, stroke, new ActionPathVertexToCusp());
        }
    }
}
