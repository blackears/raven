 ...
 * @author kitfox
 */
public class ActionFileSave extends AbstractAction
{
    private static final String name = "Save";
    private static final String id = "fileSave";
    ...
    {
        RavenEditor.inst().getDocumentIOHelper().saveFile();
    }
    ...
    public static class Provider extends ActionProvider
    {
        public Provider()
        {
            super(id, name, stroke, new ActionFileSave());
        }
    }
}
