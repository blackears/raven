 ...
 * @author kitfox
 */
public class ActionHelpWebsite extends AbstractAction
{
    private static final String name = "Website...";
    private static final String id = "helpWebsite";
    private static final KeyStroke stroke = null;

    public ActionHelpWebsite()
    {
        super(name);
    }
    ...
    public static class Provider extends ActionProvider
    {
        public Provider()
        {
            super(id, name, stroke, new ActionHelpWebsite());
        }
    }
}
