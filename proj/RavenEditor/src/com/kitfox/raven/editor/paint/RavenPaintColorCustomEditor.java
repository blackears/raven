        ...
        implements PropertyChangeListener, PropertyCustomEditor
{
    ...
    PropertyData<RavenPaintColor> curValue;
    ...
    public RavenPaintColorCustomEditor(RavenPaintColorEditor ed)
    {
        ...
        RavenPaintColor color = ed.getValueFlat();
        colorPanel.setColor(color == null ? null : color.getColor());
    }

    public void setValue(RavenPaintColor value)
    {
        setValue(new PropertyDataInline(value));
    }

    public void setValue(PropertyData<RavenPaintColor> data)
    {
        curValue = data;
    ...
    public void propertyChange(PropertyChangeEvent evt)
    {
        if (evt.getSource() == colorPanel 
                && ColorStyleEditorPanel.PROP_COLOR.equals(evt.getPropertyName()))
        {
            ColorStyle col = colorPanel.getColor();
            setValue(new RavenPaintColor(col));
        }
    }
