...
public class MultipleGradientStopsEditor extends PropertyWrapperEditor<MultipleGradientStops>
{
    ...
    {
        PropertyData<MultipleGradientStops> data = getValue();
        MultipleGradientStops stops = data.getValue(getDocument());
        return stops != null;
    }
    ...
    public void paintValue(Graphics gfx, Rectangle box)
    {
        ...
        MultipleGradientStyle style = new MultipleGradientStyle(stops);

        Paint paint = style.getPaint(new PaintLayoutTexture(box), new AffineTransform());
    ...
    {
        PropertyData<MultipleGradientStops> data = getValue();
        MultipleGradientStops stops = data.getValue(null);
    ...
    {
        MultipleGradientStops value = MultipleGradientStops.create(text);
        setValue(value);
    }
    ...
    {
        return new MultipleGradientStopsCustomEditor(this);
    }
    ...
    public static class Provider extends PropertyProvider<MultipleGradientStops>
    {
        public Provider()
        {
            super(MultipleGradientStops.class);
        }

        @Override
        public PropertyWrapperEditor createEditor(PropertyWrapper wrapper)
        {
            return new MultipleGradientStopsEditor(wrapper);
        }

        @Override
        public String asText(MultipleGradientStops value)
        {
            return value == null ? "" : value.toString();
        }

        @Override
        public MultipleGradientStops fromText(String text)
        {
            ...
            //Parse
            return MultipleGradientStops.create(text);
        }
    }
}
