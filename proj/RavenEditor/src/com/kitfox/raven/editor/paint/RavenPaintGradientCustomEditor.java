...
//    ColorStyleEditorPanel colorPanel = new ColorStyleEditorPanel();
    ...
    PropertyData<RavenPaintGradient> curValue;
    ...
    public RavenPaintGradientCustomEditor(RavenPaintGradientEditor ed)
    {
        ...
        RavenPaintGradient grad = initValue.getValue(ed.getDocument());
        gradPanel.setStops(grad.getGradient().getStops());
    }

    public void setValue(RavenPaintGradient value)
    {
        setValue(new PropertyDataInline(value));
    }

    public void setValue(PropertyData<RavenPaintGradient> data)
    {
        curValue = data;
