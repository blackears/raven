...
import com.kitfox.raven.editor.RavenViewManager.DockableMenuItem;
...
public class MenuListViewViews extends MenuListProvider
{
    ...
    public void buildMenu(JMenu parent)
    {
        ...
        for (DockableMenuItem item: viewManager.getViewMenuItems())
        {
            parent.add(item);
        }
    }
