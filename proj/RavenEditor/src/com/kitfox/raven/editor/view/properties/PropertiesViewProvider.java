...
public class PropertiesViewProvider extends ViewProvider
{
    public PropertiesViewProvider()
    {
        super("Properties", "/icons/view/properties.png");
    }

    @Override
    public Component createComponent(RavenEditor editor)
    {
        return new PropertiesPanel(editor);
    }
