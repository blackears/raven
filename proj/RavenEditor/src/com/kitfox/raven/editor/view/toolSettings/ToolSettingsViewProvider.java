...
public class ToolSettingsViewProvider extends ViewProvider
{

    public ToolSettingsViewProvider()
    {
        super("Tool Settings", "/icons/view/toolSettings.png");
    }

    @Override
    public Component createComponent(RavenEditor editor)
    {
        return new ToolSettingsPanel(editor);
    }
