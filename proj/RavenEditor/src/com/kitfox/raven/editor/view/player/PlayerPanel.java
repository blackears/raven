...
//            listenerTrackLibTrack = null;
        ...
        if (doc != null)
        {
            ...
            listenerTrackLibFrame = new PropertyWrapperWeakListener(this, trackLib.frameCur);
            trackLib.frameCur.addPropertyWrapperListener(listenerTrackLibFrame);
...
//            combo_track.removeAllItems();
        ...
        text_curFrame.setText("" + trackLib.frameCur.getValue());
...
//            updateTickSpacing();
//            slider_frame.setValue(trackLib.getFrameCur());
//        }

        int min = trackLib.getFrameFirst();
        int max = trackLib.getFrameLast();
        text_firstFrame.setText("" + min);
        text_lastFrame.setText("" + max);
        slider_frame.setEnabled(true);
        slider_frame.setMinimum(min);
...
//        TrackLibrary lib = (TrackLibrary)track.getParent().getNode();
        ...
        try
        {
            ...
            lib.frameCur.setValue(value, false);
        }
...
//        TrackLibrary lib = (TrackLibrary)track.getParent().getNode();
        ...
        int frameStart = lib.getFrameFirst();
        int frameEnd = lib.getFrameLast();
        boolean loop = lib.loop.getValue();
        int curFrame = lib.frameCur.getValue();
...
//        TrackLibrary lib = (TrackLibrary)track.getParent().getNode();
        ...
        int newFrame = Math.max(frameStart,
                sym.getRoot().getPrevKeyFrame(curFrame));
...
//        TrackLibrary lib = (TrackLibrary)track.getParent().getNode();
        ...
        int newFrame = Math.min(frameEnd,
                sym.getRoot().getNextKeyFrame(curFrame));
...
//        TrackLibrary lib = (TrackLibrary)track.getParent().getNode();
        ...
        int frameStart = lib.getFrameFirst();
        lib.frameCur.setValue(frameStart, false);
    }
...
//        TrackLibrary lib = (TrackLibrary)track.getParent().getNode();
        ...
        int frameEnd = lib.getFrameLast();
        lib.frameCur.setValue(frameEnd, false);
    }
...
//        TrackLibrary lib = (TrackLibrary)track.getParent().getNode();
        ...
        lib.frameCur.setValue(slider_frame.getValue(), false);
    }
...
//            }
        ...
        public void nodePropertyChanged(PropertyChangeEvent evt)
        {
            if (TrackLibrary.PROP_FRAMECUR.equals(evt.getPropertyName()))
            {
                ++updating;
                int value = trackLib.getFrameCur();
                text_curFrame.setText("" + value);
                slider_frame.setValue(value);
                --updating;
            }
            else if (TrackLibrary.PROP_FRAMEFIRST.equals(evt.getPropertyName()))
            {
                updateModelSwing();
            }
            else if (TrackLibrary.PROP_FRAMELAST.equals(evt.getPropertyName()))
            {
                updateModelSwing();
            }
