...
public class CameraDisplayViewProvider extends ViewProvider
{

    public CameraDisplayViewProvider()
    {
        super("Camera Display", "/icons/view/cameraDisplay.png");
    }

    @Override
    public Component createComponent(RavenEditor editor)
    {
        return new CameraDisplayPanel(editor);
    }
