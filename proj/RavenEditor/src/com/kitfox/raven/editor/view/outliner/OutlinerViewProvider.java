...
public class OutlinerViewProvider extends ViewProvider
{

    public OutlinerViewProvider()
    {
        super("Outliner", "/icons/view/outliner.png");
    }

    @Override
    public Component createComponent(RavenEditor editor)
    {
        return new OutlinerPanel(editor);
    }
