...
public class StyleStrokeDashArrayLoader extends StyleElementLoader
{

    public StyleStrokeDashArrayLoader()
    {
        super("stroke-dasharray", StyleKey.STROKE_DASHARRAY);
    }


    @Override
    public float[] parse(String value, RabbitDocument builder)
    {
