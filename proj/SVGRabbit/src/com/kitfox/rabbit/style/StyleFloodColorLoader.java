...
public class StyleFloodColorLoader extends StyleElementLoader
{

    public StyleFloodColorLoader()
    {
        super("flood-color", StyleKey.FLOOD_COLOR);
    }
    ...
    public Color parse(String value, RabbitDocument builder)
    {
        ...
        try {
            ...
            Logger.getLogger(StyleFloodColorLoader.class.getName()).log(Level.SEVERE, null, ex);
        }
        return null;
    }
