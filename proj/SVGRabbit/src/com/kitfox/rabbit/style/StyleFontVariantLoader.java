...
public class StyleFontVariantLoader extends StyleElementLoader
{

    public StyleFontVariantLoader()
    {
        super("font-variant", StyleKey.FONT_VARIANT);
    }


    @Override
    public FontVariant parse(String value, RabbitDocument builder)
    {
