...
public class StyleLightingColorLoader extends StyleElementLoader
{

    public StyleLightingColorLoader()
    {
        super("lighting-color", StyleKey.LIGHTING_COLOR);
    }
    ...
    public Color parse(String value, RabbitDocument builder)
    {
        ...
        try {
            ...
            Logger.getLogger(StyleLightingColorLoader.class.getName()).log(Level.SEVERE, null, ex);
        }
        return null;
    }
