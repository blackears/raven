...
public class StyleVisibilityLoader extends StyleElementLoader
{

    public StyleVisibilityLoader()
    {
        super("visiblity", StyleKey.VISIBILITY);
    }


    @Override
    public Visibility parse(String value, RabbitDocument builder)
    {
