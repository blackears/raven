...
public class GVector implements java.io.Serializable, Cloneable
{
     ...
     */
    public GVector(CyVector2d tuple)
    {
        values = new double[2];
     ...
     * @param tuple the source for the new GVector's initial values
     */
    public GVector(CyVector3d tuple)
    {
        values = new double[3];
        values[0] = (double) tuple.x;
        values[1] = (double) tuple.y;
     ...
     * @param tuple the source for the new GVector's initial values
     */
    public GVector(CyVector4d tuple)
    {
        values = new double[4];
        values[0] = tuple.x;
        values[1] = tuple.y;
    ...
    public final void normalize(GVector v1)
    {
        ...
        if (length != v1.length)
        {
            throw new UnsupportedOperationException("MismatchedSizeException");
        }
     ...
     */
    public final void set(CyVector2d tuple)
    {
        if (length < 2)
        {
            length = 2;
     ...
     * @param tuple the source for the new GVector's new values
     */
    public final void set(CyVector3d tuple)
    {
        if (length < 3)
        {
            length = 3;
     ...
     * @param tuple the source for the new GVector's new values
     */
    public final void set(CyVector4d tuple)
    {
        if (length < 4)
        {
            length = 4;
