 ...
 * @author kitfox
 */
public class CyVertexBufferDataSquareLines extends CyVertexBufferDataProvider
{
    ...
    private static CyVertexBufferDataSquareLines instance = new CyVertexBufferDataSquareLines();

    private final CyVertexBuffer buffer;

    private CyVertexBufferDataSquareLines()
    {
    ...
    public static CyVertexBufferDataSquareLines inst()
    {
        return instance;
    }
