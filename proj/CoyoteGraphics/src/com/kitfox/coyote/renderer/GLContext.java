...
//    ReferenceQueue vboQueue = new ReferenceQueue();
    ...
    HashMap<Reference, GLAction> dieMap = new HashMap<Reference, GLAction>();
    ...
    public void processActions(GLWrapper wrapper)
    {
        ...
        while (true)
        {
            ...
            GLAction action = dieMap.remove(ref);
    ...
    public VertexBufferInfo getVertexBufferInfo(CyVertexBuffer source, GLWrapper gl)
    {
    ...
    public TextureBufferInfo getTextureBufferInfo(Object source, GLWrapper gl)
    {
    ...
    public FramebufferInfo getFramebufferInfo(Object source, GLWrapper gl)
    {
    ...
    public RenderbufferInfo getRenderbufferInfo(Object source, GLWrapper gl)
    {
    ...
    public class RenderbufferInfo implements GLAction
    {
        private final int rboId;
        private int dirty;

        public RenderbufferInfo(GLWrapper gl)
        {
    ...
    public class FramebufferInfo implements GLAction
    {
        private final int fboId;
        private int dirty;

        public FramebufferInfo(GLWrapper gl)
        {
            IntBuffer ibuf = BufferUtil.allocateInt(1);
    ...
    public class TextureBufferInfo implements GLAction
    {
        private final int texId;
        private int dirty;

        public TextureBufferInfo(GLWrapper gl)
        {
            IntBuffer ibuf = BufferUtil.allocateInt(1);
    ...
    public class VertexBufferInfo implements GLAction
    {
...
//        WeakReference<CyVertexBuffer> sourceRef;
        ...
        public VertexBufferInfo(CyVertexBuffer source, GLWrapper gl)
        {
