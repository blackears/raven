...
//        setDividerSize(8);
    ...
    {
        {
            Point relPoint = SwingUtilities.convertPoint(this, containerPoint, leftComponent);
        ...
        {
            Point relPoint = SwingUtilities.convertPoint(this, containerPoint, rightComponent);
