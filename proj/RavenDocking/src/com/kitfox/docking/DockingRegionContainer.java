        ...
        implements DockingContainer
{
    ...
    ArrayList<MinMaxRecord> minimizedRecords = new ArrayList<MinMaxRecord>();

    MinMaxRecord maximizedRecord;
    private DockingRegionRoot dockRoot;
...
//        DockingRegionTabbed tab = (DockingRegionTabbed)partialPath.getLast().getDockingChild();
        ...
        centerWindow(win, SwingUtilities.getWindowAncestor(dockRoot).getBounds());
    }
