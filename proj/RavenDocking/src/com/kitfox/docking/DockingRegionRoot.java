...
{
    private DockingRegionContainer dockingRoot;
    
    ArrayList<DockingRegionWindow> floating
            = new ArrayList<DockingRegionWindow>();
    ArrayList<DockingRegionContainer> containers
            = new ArrayList<DockingRegionContainer>();
    ...
    {
        for (DockingRegionWindow win: new ArrayList<DockingRegionWindow>(floating))
        {
