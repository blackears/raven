 ...
 * @author kitfox
 */
public class ColorFieldHS extends ColorModelColorField
{
    ...
    public ColorFieldHS(ColorChooserModel model)
    {
        super(model);
    }
...
//        Color colorRgb = color.getColor();
//        Color.RGBtoHSB(colorRgb.getRed(), colorRgb.getGreen(), colorRgb.getBlue(), hsb);
        return new Point2D.Float(hsv[0], hsv[1]);
    }
