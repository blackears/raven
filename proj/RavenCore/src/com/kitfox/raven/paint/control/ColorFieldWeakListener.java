...
public class ColorFieldWeakListener implements ColorFieldListener
{
    ...
    final ColorField src;

    public ColorFieldWeakListener(ColorFieldListener listener, ColorField src)
    {
        this.ref = new WeakReference<ColorFieldListener>(listener);
        this.src = src;
    }

    public void remove()
    {
        src.removeColorFieldListener(this);
    }

    public void colorFieldChanged(ChangeEvent evt)
    {
        ColorFieldListener l = ref.get();
        if (l == null)
        {
            remove();
            return;
