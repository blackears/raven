...
public class MeshSegPaintLeft extends MeshSegment
{
    ...
    public MeshSegPaintLeft(int id)
    {
        this.id = id;
    }

    public static MeshSegPaintLeft create(String strn)
    {
        int[] arr = NumberText.findIntegerArray(strn.substring(1));
        return new MeshSegPaintLeft(arr[0]);
    }
    ...
    public boolean equals(Object obj) {
        ...
        final MeshSegPaintLeft other = (MeshSegPaintLeft) obj;
        if (this.id != other.id) {
            return false;
        }
        return true;
