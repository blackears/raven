...
public class Contour
{
    ...
    public void append(Contour contourStart)
    {
        points.addAll(contourStart.points);
    }

    public ContourPoint getLastPoint()
    {
    ...
    private FitCurveRecord fitSection(int startX, int endX)
    {
        ...
        for (int i = 1; i < numPoints; ++i)
        {
            ...
            dist += BezierMath.distance(p0x, p0y, p1x, p1y);
            Ptimes[i] = dist;
        }
        ...
        for (int i = 0; i < numPoints; ++i)
        {
            ...
            double curveDist = BezierMath.distance(evalPt[0], evalPt[1],
