...
public class StrokeStyleCustomEditor extends javax.swing.JPanel implements PropertyChangeListener
{
    ...
    StrokeStyleEditor ed;

    boolean updating = true;

    /** Creates new form StrokeStyleCustomEditor */
    public StrokeStyleCustomEditor(StrokeStyleEditor ed)
    {
        this.ed = ed;
        initComponents();
    ...
    public void update()
    {
        ...
        StrokeStyle stroke = ed.getValue();
        if (stroke == null)
        {
        ...
        float[] dashArray = stroke.getDash();
        text_dash.setText(dashArray == null ? "" : NumberText.asString(dashArray, ","));
        text_dashPhase.setText("" + stroke.getDashPhase());
