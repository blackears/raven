 ...
 */
@Deprecated
public class ColorStyleEditorPanel extends javax.swing.JPanel
        implements PropertyChangeListener
{
    ...
    private void updateText()
    {
        ...
        ColorStyle col = model.getColor();
        col.RGBtoHSV(col.r, col.g, col.b, hsv);

        spinner_r.setValue((int)(col.r * 255 + .5f));
        spinner_g.setValue((int)(col.g * 255 + .5f));
        spinner_b.setValue((int)(col.b * 255 + .5f));

        spinner_h.setValue((int)(hsv[0] * 359 + .5f));
        spinner_s.setValue((int)(hsv[1] * 100 + .5f));
        spinner_v.setValue((int)(hsv[2] * 100 + .5f));

        spinner_a.setValue((int)(col.a * 255 + .5f));
    ...
    private void setTextHSV()
    {
        ...
        ColorStyle.HSVtoRGB(h / 360f, s / 100f, v / 100f, rgb);
        model.setColor(new ColorStyle(rgb[0], rgb[1], rgb[2], a / 255f));
    }
    ...
    private void setTextRGB()
    {
        ...
        model.setColor(new ColorStyle(r, g, b, a));
    }
    ...
    private void initComponents() {
        ...
        panel_alphaLayout.setHorizontalGroup(
            ...
            .addGroup(panel_alphaLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(panel_alphaSlider, javax.swing.GroupLayout.DEFAULT_SIZE, 398, Short.MAX_VALUE))
        );
